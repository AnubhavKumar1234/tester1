...
import io.github.bonigarcia.wdm.WebDriverManager;
 ...
 class EmptyCartValidationTest
{
	@Test
	public void orderPacing() throws InterruptedException 
	{
...
//		driver.findElement(By.linkText("Add to cart")).click();
		...
		driver.findElement(By.xpath("//a[text()='Samsung galaxy s7']")).click();
				...
				driver.findElement(By.xpath("//label[text()='Country:']/following-sibling::input")).sendKeys("India");
				driver.findElement(By.id("city")).sendKeys("Hyderabad");
			    driver.findElement(By.id("card")).sendKeys("123456789");
			    driver.findElement(By.id("month")).sendKeys("march");
			    driver.findElement(By.id("year")).sendKeys("2024");
			    driver.findElement(By.xpath("//button[text()='Purchase']")).click();
			    String Thanksmsg = driver.findElement(By.xpath("//h2[text()='Thank you for your purchase!']")).getText();
